    ...
    <Stack.Navigator initialRouteName="Emergency">
      ...
      <Stack.Screen name="EmergencyDetail" component={EmergencyDetail} options={
        ({ route }) => ({
          headerStyle: {
            backgroundColor: "#61D8CF"
          }, headerTintColor: "#AF4242", headerTitleStyle: { fontWeight: "bold", fontSize: "8vw" }, headerTitleAlign: "center", headerTitle: route.params.title
        })
      }/>
      <Stack.Screen name="ServiceDetail" component={ServiceDetail} options={
        ({ route }) => ({
          headerStyle: {
            backgroundColor: "#61D8CF"
          }, headerTintColor: "#AF4242", headerTitleStyle: { fontWeight: "bold", fontSize: "8vw" }, headerTitleAlign: "center", headerTitle: route.params.category.c_name
        })
      }/>
    </Stack.Navigator>
  );
